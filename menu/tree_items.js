...
var TREE_ITEMS = [
	...
	[' FranqWare', '../main/home_page.htm',
		...
		[' Memoriaren eranskinak',null,
			[' A1 - Sarrerako Dokumentazioa',null,
				['Domeinuari buruzko informazioa',null,
					...
					['Frankiziei buruzko informazioa','../Proiektua/MemoriarenEranskinak/FrankizieiBuruzkoInformazioa.pdf'],
					['Frankizien hornitzailei buruzko informazioa','../Proiektua/MemoriarenEranskinak/FrankizienHornitzaileeiBuruzkoInformazioa.pdf'],
				],
				['Bezeroak proposatutako ebaluazio-txantiloiak',null,
					...
					['User acceptace test (UAT) txantiloia',null],//'../Proiektua/MemoriarenEranskinak/User-Accetptance-Test-Plan-Free-Word-Template.pdf'],
					['RFP erantzunen hasierako ebaluazioaren txantiloia',null],//'../Proiektua/MemoriarenEranskinak/Software projects proposals evaluation template.pdf'],
				],
				['Bezeroari buruzko informazioa','https://www.groupe.schmidt/es/trabaje-con-nosotros/convertirse-en-concesionario-schmidt/quienes-somos/'],
				['Bezeroaren proposamen eskaera (Request for proposals - RFP)',null,
					...
					['Bezeroarengandik jasotako RFP','../Proiektua/MemoriarenEranskinak/rfp-SCHMIDT.pdf'],
				],
			],
			[' A2 - Analisi eta Diseinua',null,
				[' Analisia',null,
					[' Analisis Model',null],//'../Proiektua/MemoriarenEranskinak/UML/RSAD/index.html'],
				],
				[' Arkitektura ', null,
					['Arkitektura dokumentua (Architecture Notebook)',null],//'../Proiektua/MemoriarenEranskinak/ArchitectureNotebook.pdf'],
					['Arkitektura eredua (azalekoa)',null],//'../Proiektua/MemoriarenEranskinak/arkitektura.png'],
					['Arkitektura eredua (azalekoa azaldua)',null],//'../Proiektua/MemoriarenEranskinak/Architectura_azalpenekin.pdf'],
					['Arkitektura eredua',null],//'../Proiektua/MemoriarenEranskinak/OsagaienDiagrama_Arkitektura.png'],
				],
				[' Diseinua',null,
					['Design Model',null],
			...
			[' A3 - Proposamenaren tamaina eta esfortzu estimazioa',null,
				[' UML ereduei aplikatutako metriken emaitazk',null,
					[' Software Architect: Analisi metriken txostena',null],//'../Proiektua/MemoriarenEranskinak/RSAD_Analisis/umleview_result.html'],
					[' SDMetrics: Erabilpen-kasuen ereduaren metrikak',null],//'../Proiektua/SistemarenEspezifikazioa/UML/RSAD/SDMetrics_Erabilpen-kasuen_eredua.xlsx'],
					[' SDMetrics: Analisi ereduaren metrikak',null],//'../Proiektua/MemoriarenEranskinak/UML/RSAD/SDMetrics_Analisi_eredua.xlsx'],
				],
				[' Kodeari aplikatutako metriken emaitazk',null],
			],

			[' A4 - Proposamenaren kudeaketa plana', null,//'../Proiektua/MemoriarenEranskinak/KudeaketaPlana.pdf',
			...
			[' A5 - Proposamenaren segurtasun plana',null,
 			...
 			[' A6 - Gainerako Eranskinak', null,
				...
				[' Test' , null,
					[' Trazabilitate Matrizea', null], //'../Proiektua/MemoriarenEranskinak/TrazabilitateMatrizea.svg'],
					[' Proba Kasuak', null],
					[' Proba Log-a', null],
					[' Proba Script-a', null],
		...
		[' Sistemaren Espezifikazioa',null,
			...
			[' Erabilpen kasuak (jarduera diagramekin)', null,
				...
				[' Financial Management (UML)', null,],
				[' Manage menu', null,],//'../Proiektua/SistemarenEspezifikazioa/usecase_specification_Manage menu.pdf'],
				[' Manage menu (UML)', null,],
				[' Process Order', null,],//'../Proiektua/SistemarenEspezifikazioa/usecase_specification_Process Order.pdf'],
				[' Process Order (UML)', null,],//'../Proiektua/SistemarenEspezifikazioa/glossary.pdf'],
				[' Standardized Processes and Practices',null,
					[' Use-case specification (OpenUP)', '../Proiektua/SistemarenEspezifikazioa/usecase_specification_Standardized Processes and Practices.pdf'],
					[' Activity diagram (UML)',null,],
					[' Lan-fluxuen definizioa', null,],//'https://graphviz.org/'],
			...
			[' Use Case Model', null,], //'../Proiektua/SistemarenEspezifikazioa/UML/RSAD/index.html'],
		],
	...
	['FranqWare: Barne Kudeaketa', null,
		...
		[' Ingurunea', null,
			[' OpenUpLifecycleProccess+CCII', null,
				...
				['OpenUP+CCII prozesua (html)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleProccess/OpenUP+CCII/index.html'],
				['OpenUP+CCII prozesua (bpm)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleProccess/OpenUP+CCII/OpenUP+CCII.bpm'],
				['OpenUP+CCII prozesua (pdf)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleProccess/bpmDokumentua.pdf'],
				['OpenUP+CCII dokumentazioa (pdf)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleProccess/Erabakien_justifikazioa.pdf'],
			],
			[' OpenUpLifecycleWorkflow', null,
				['OpenUP+CCII prozesua (html)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleWorkflow/openUp_lifecycle.html'],
				['OpenUP+CCII prozesua (zip)', null],//'../Proiektua/BarneKudeaketa/OpenUpLifecycleWorkflow/openUp_lifecycle.zip'],
				['dot lengoaia(Graphviz)', null],//'https://graphviz.org/doc/info/lang.html'],
				['GraphML formatoa', null],//'http://graphml.graphdrawing.org/'],
				['dot -> GraphML bihurtzailea (Gephi)', null],//'https://gephi.org/'],
				['Grafoen datu-basea(Neo4j)', null],//'https://neo4j.com/'],
			],
			['Erremintak', null,],
		],
